...
{
    public partial class Aktualisfelhasznaloifiokok : Form
    {
        public Aktualisfelhasznaloifiokok()
        {
            InitializeComponent();
        }

        private void Aktualisfelhasznaloifiokok_Load(object sender, EventArgs e)
        {
